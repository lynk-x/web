...
import SystemJobsTab from '@/components/system/audit/SystemJobsTab';
...
export default function JobsOperationsPage() {
    return (
        <Suspense fallback={<div className={adminStyles.loading}>Loading Operations Dashboard...</div>}>
            <JobsOperationsContent />
        </Suspense>
    );
}
