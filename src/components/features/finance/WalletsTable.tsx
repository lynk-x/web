        ...
        },
        {
            ...
            render: (wallet: AccountWallet) => (
                <div style={{ display: 'flex', gap: '8px' }}>
                    <Button variant="secondary" onClick={() => { setSelectedWallet(wallet); setActiveModal('history'); }}>History</Button>
                    <Button variant="secondary" onClick={() => { setSelectedWallet(wallet); setActiveModal('topup'); }}>Top Up</Button>
                    <Button variant="secondary" onClick={() => { setSelectedWallet(wallet); setActiveModal('transfer'); }}>Transfer</Button>
                    <Button variant="primary" onClick={() => { setSelectedWallet(wallet); setActiveModal('withdraw'); }}>Withdraw</Button>
                </div>
            )
        }
    ];
