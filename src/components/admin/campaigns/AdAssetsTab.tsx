...
export default function AdAssetsTab() {
            ...
            render: (a) => (
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    {a.type.startsWith('image') ? (
                        <img src={a.url} alt="ad asset" style={{ width: 48, height: 32, objectFit: 'cover', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.1)' }} onError={e => { (e.target as any).style.display = 'none'; }} />
                    ) : (
    ...
    const getActions = (a: AdAsset) => [
        ...
        {
            label: 'Delete Asset', variant: 'danger' as any,
