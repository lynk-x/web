    ...
    const getActions = (item: ContentItem): ActionItem[] => [
        {
            ...
            onClick: () => router.push(`/dashboard/system/communications/edit/${item.id}`),
        },
        {
            label: 'Delete',
            ...
            onClick: () => {
                // TODO: Wire up a real delete RPC and call showToast only on confirmed success.
                // A setTimeout-based success toast is misleading — it fires regardless of outcome.
                console.warn('Content delete action is not yet connected to an API call.', item.id);
                showToast('Delete not yet implemented.', 'info');
            },
        },
    ];
