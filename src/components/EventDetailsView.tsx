                ...
                >
                    <div className={styles.hero}>
                        {event.cover_image_url ? (
                            <img src={event.cover_image_url} alt={event.title} className={styles.heroImage} style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: 'var(--radius-xl)' }} />
                        ) : (
                    ...
                    <div className={styles.footerActions}>
                        <Link
                            ...
                            style={{
                                textAlign: 'center',
                                display: 'block',
                                opacity: selectedTicket !== null ? 1 : 0.5,
                                pointerEvents: selectedTicket !== null ? 'auto' : 'none'
                            }}
                        >
                            Get ticket {selectedTicket !== null && `(KES ${selectedTicket === 0 ? event.low_price : /* Logic for other tickets would go here */ event.low_price * 2})`}
                        </Link>
                    </div>
                </motion.div>
            </div>
