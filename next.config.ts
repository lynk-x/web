...
const securityHeaders = [
  ...
  { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=()' },
  {
    ...
    value: [
      ...
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://fcm.googleapis.com https://fcmregistrations.googleapis.com https://*.fcmregistrations.googleapis.com https://firebaseinstallations.googleapis.com https://*.firebaseinstallations.googleapis.com https://*.googleapis.com https://*.r2.cloudflarestorage.com https://cdn.lynk-x.app https://cdn.jsdelivr.net https://fonts.gstatic.com https://www.gstatic.com https://unpkg.com https://cdnjs.cloudflare.com https://*.google.com https://*.gstatic.com",
      "frame-src 'self'",
